...
| Property            | Required | Type | Description                                                                                                                                                                                                                                                                                                      |
|---------------------|----------|------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| total.withouttax    | true     | int  | Total payment excluding tax in 1/100 of currency (i.e. öre if currency is SEK, cent if currency is EUR). Amount given will be checked against summation of all articles[x].withouttax, handlingcharge.withouttax and shipping.withouttax. If not matching values, an error will be returned.                     |
| total.tax           | true     | int  | Total tax in 1/100 of currency (i.e. öre if currency is SEK, cent if currency is EUR).                                                                                                                                                                                                                           |
