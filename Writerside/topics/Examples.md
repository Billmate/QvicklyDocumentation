...
|------------------|-------------------------------------|-------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| %code-json%      | 28/%NUMBER_OF_PAYMENT_API_EXAMPLES% | 28/%NUMBER_OF_PAYMENT_API_EXAMPLES% | JSON basic example payloads. Updated 2024.                                                                                                                                             |
...
| %code-php%       | 0/%NUMBER_OF_PAYMENT_API_EXAMPLES%  | 28/%NUMBER_OF_PAYMENT_API_EXAMPLES% | New PHP code. Updated 2024 to a more modern style.                                                                                                                                     |
