...
This is the example for getPaymentinfo. The documentation for can be found [here](getPaymentinfo.md)
...
Full example can be found [here](https://github.com/Billmate/qvickly-php-module/blob/main/examples/PaymentAPI/Simple/getPaymentInfo.php)
